...
export function useGestureRulesStore() {
  ...
  return proxyRefs({
    ...
    getCategoriesForApplication: editor.getCategoriesForApplication,
    getGestureMnemonic,
    ...
    moveApplicationCategory: editor.moveApplicationCategory,
    ...
    setApplicationCategories: editor.setApplicationCategories,
