...
<img src="docs/images/yanshi.gif" alt="使用中的手势提示" style="zoom: 50%;" />

手势轨迹与命中动作会直接作用于起始窗口，也可配置为当前窗口。

<img src="docs/images/global-rules.webp" alt="全局手势规则界面" style="zoom: 50%;" />
